...
class QuestionResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final palette = _ResultBreakdownPalette.forState(isCorrect);
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Icon(
                    isCorrect ? Icons.celebration_outlined : Icons.close,
                    size: 18,
                    color: isCorrect ? palette.title : const Color(0xFF111827),
                  ),
                ),
            ...
            _AnswerRow(label: 'Correct', value: correctAnswer, isCorrect: true),
            const SizedBox(height: 8),
            Text(
              explanation,
              style: TextStyle(
...
class _ResultBreakdownPalette {
  ...
  factory _ResultBreakdownPalette.forState(bool isCorrect) {
    if (isCorrect) {
      return const _ResultBreakdownPalette(
